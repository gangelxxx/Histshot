...
public partial class EditorControl : UserControl
{
    ...
    public async Task CopyAsync(string? comment = null, DateTime? reminderAt = null)
    {
        try
        {
            FinalizeTextInput();
            ...
            var id = await historyService.SaveAsync(result.Copy(), comment);
            if (reminderAt.HasValue)
                await historyService.SetReminderAsync(id, reminderAt.Value);
