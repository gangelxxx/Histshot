...
public partial class CaptureOverlayWindow : Window
{
    ...
    public CaptureOverlayWindow(IScreenCaptureService captureService, PixelRect screenBounds, double scaling, Action? closeAllOverlays, CapturedImage? capturedImage = null)
    {
        ...
        _toolbarControl.ReminderRequested += OnReminderRequested;
    ...
    private async void OnCopyRequested(object? sender, EventArgs e)
    {
        ...
        await _editorControl.CopyAsync(_toolbarControl?.Comment, _toolbarControl?.ReminderAt);
    }
    ...
    private async void OnReminderRequested(object? sender, EventArgs e)
    {
        ...
        var dialog = new ReminderDialog(_toolbarControl.ReminderAt)
        {
        ...
        _toolbarControl.SetReminder(result.Remove ? null : result.When);
    }
